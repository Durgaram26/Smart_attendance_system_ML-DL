...
def start():
    global stop_flag
    stop_flag.clear()  # Clear the stop flag to start the attendance process
    ...
    while not stop_flag.is_set():
        ...
        # Ensure face_locations is a list of tuples
        if not isinstance(face_locations, list) or not all(isinstance(loc, tuple) for loc in face_locations):
            face_locations = []
